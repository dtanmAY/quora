  ...
  <body>
    ...
    <?php require("menu_bar.php"); ?>
      ...
      <!-- creating a text area for my editor in the form -->
        <h1>Add Post</h1>
        <br>
          <input type="text" class="form-control" name="post_title" placeholder="Enter POST Titile">
          <br>
          <textarea id="myeditor" name="post" placeholder="Enter Your Text Inside" rows="20"></textarea>
